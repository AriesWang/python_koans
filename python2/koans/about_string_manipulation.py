...
class AboutStringManipulation(Koan):
    ...
    def test_use_format_to_interpolate_variables(self):
        ...
        string1="The values are one and 2"
        self.assertEqual(string1, string)

    def test_formatted_values_can_be_shown_in_any_order_or_be_repeated(self):
        value1 = 'doh'
        value2 = 'DOH'
        string = "The values are {1}, {0}, {0} and {1}!".format(value1, value2)
        string1 = "The values are DOH, doh, doh and DOH!"
        self.assertEqual(string1, string)
    ...
    def test_any_python_expression_may_be_interpolated(self):
        ...
        string = "The square root of 5 is {0:.{1}f}".format(math.sqrt(5), \
            decimal_places)
        string1="The square root of 5 is 2.2361"
        self.assertEqual(string1, string)
    ...
    def test_strings_can_be_joined(self):
        ...
        self.assertEqual(string, ' '.join(words))
